...
public class KeyBindingOpenGui extends ElementsMemewareMod.ModElement {
	private KeyBinding keys;
	public KeyBindingOpenGui(ElementsMemewareMod instance) {
		super(instance, 2);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.open_gui", Keyboard.KEY_G, "key.categories.misc");
