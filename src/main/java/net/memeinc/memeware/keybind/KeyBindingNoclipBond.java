...
import net.memeinc.memeware.procedure.ProcedureNoclipBondOnKeyPressed;
...
public class KeyBindingNoclipBond extends ElementsMemewareMod.ModElement {
	private KeyBinding keys;
	public KeyBindingNoclipBond(ElementsMemewareMod instance) {
		super(instance, 56);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.noclip_bond", Keyboard.KEY_0, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureNoclipBondOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
