...
import net.memeinc.memeware.procedure.ProcedureMemedarOnKeyPressed;
...
public class KeyBindingMemedar extends ElementsMemewareMod.ModElement {
	private KeyBinding keys;
	public KeyBindingMemedar(ElementsMemewareMod instance) {
		super(instance, 58);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.memedar", Keyboard.KEY_0, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureMemedarOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
