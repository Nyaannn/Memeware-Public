...
public class ProcedureOldClip extends ElementsMemewareMod.ModElement {
	public ProcedureOldClip(ElementsMemewareMod instance) {
		super(instance, 45);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure OldClip!");
			return;
		}
		...
		double sy = 0;
		double sz = 0;
		if (((MemewareModVariables.OldClip) == (true))) {
