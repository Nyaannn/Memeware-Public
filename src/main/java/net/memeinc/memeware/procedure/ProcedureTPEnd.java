...
public class ProcedureTPEnd extends ElementsMemewareMod.ModElement {
	public ProcedureTPEnd(ElementsMemewareMod instance) {
		super(instance, 54);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure TPEnd!");
			return;
		}
