...
public class MemewareModVariables {
	public static boolean AutoShulk = false;
	public static boolean AutoShulkInverted = false;
	public static boolean CrystalAura = false;
	public static boolean Flight = false;
	public static boolean RVelocity = false;
	public static boolean Noclip = false;
	public static double ncmax = 0;
	public static String Tracker = "";
	public static boolean TToggle = false;
	public static boolean TPTTOGGLE = false;
	public static boolean OldClip = false;
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "memeware_mapvars";
		public MapVariables() {
			super(DATA_NAME);
		}
		...
		public void syncData(World world) {
			this.markDirty();
			if (world.isRemote) {
				MemewareMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(0, this));
			} else {
				MemewareMod.PACKET_HANDLER.sendToAll(new WorldSavedDataSyncMessage(0, this));
			}
		}
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "memeware_worldvars";
		...
		public void syncData(World world) {
			this.markDirty();
			if (world.isRemote) {
				MemewareMod.PACKET_HANDLER.sendToServer(new WorldSavedDataSyncMessage(1, this));
			} else {
				MemewareMod.PACKET_HANDLER.sendToDimension(new WorldSavedDataSyncMessage(1, this), world.provider.getDimension());
			}
		}
	...
	public static class WorldSavedDataSyncMessageHandler implements IMessageHandler<WorldSavedDataSyncMessage, IMessage> {
		...
		private void syncData(WorldSavedDataSyncMessage message, MessageContext context, World world) {
			if (context.side == Side.SERVER) {
				...
				if (message.type == 0)
					MemewareMod.PACKET_HANDLER.sendToAll(message);
				else
					MemewareMod.PACKET_HANDLER.sendToDimension(message, world.provider.getDimension());
			}
			if (message.type == 0) {
